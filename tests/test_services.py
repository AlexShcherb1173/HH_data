...
from src.services import format_salary, format_vacancy, safe_get_salary


class TestSalaryUtils(unittest.TestCase):

    # ------------------- Тесты для safe_get_salary -------------------
    def test_safe_get_salary_none(self) -> None:
        self.assertEqual(safe_get_salary(None), (None, None, None))

    def test_safe_get_salary_empty_dict(self) -> None:
        self.assertEqual(safe_get_salary({}), (None, None, None))

    def test_safe_get_salary_partial(self) -> None:
    ...
    def test_safe_get_salary_full(self) -> None:
    ...
    def test_format_vacancy_full(self) -> None:
        ...
        expected = (
            "Python Developer | Компания: TechCorp | Зарплата: от 50000 до 70000 RUB | Ссылка: http://example.com"
        )
        self.assertEqual(format_vacancy(vacancy), expected)

    def test_format_vacancy_no_salary(self) -> None:
        vacancy = {
            "name": "Python Developer",
            "company": "TechCorp",
            "salary_from": None,
    ...
    def test_format_vacancy_from_only(self) -> None:
        vacancy = {
            "name": "Python Developer",
            "company": "TechCorp",
            "salary_from": 60000,
    ...
    def test_format_vacancy_to_only(self) -> None:
        vacancy = {
            "name": "Python Developer",
            "company": "TechCorp",
            "salary_from": None,
